...
Source code of the intellij IDEA "Copy/Paste Stack Plugin":http://plugins.intellij.net/plugin/index?pr=&pluginId=6149
...
* One or multiple items can be inserted into the editor via ENTER key or double click.
